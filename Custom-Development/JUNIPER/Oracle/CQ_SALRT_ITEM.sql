/* Formatted on 2025-09-04 17:20:35 (QP5 v5.294) */
/*|| Custom Development || Object : CQ_SALRT_ITEM || Ticket Id :  429798 || Developer : Dipankar ||*/
     ...
     AS (  SELECT M.RTCODE,
             ...
             FROM SALRTDET M
                  INNER JOIN SALINVDET SID
                     ON M.SALINVDET_CODE = SID.CODE AND M.INVCODE = SID.INVCODE
                  INNER JOIN INVDCDET DCD
                     ON     SID.INVDCDET_CODE = DCD.DCCODE
                        AND SID.DCCODE = DCD.DCCODE
