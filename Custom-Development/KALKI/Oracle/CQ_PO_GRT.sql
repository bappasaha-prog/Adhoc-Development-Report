/*|| Custom Development || Object : CQ_PO_GRT || Ticket Id :  426265 || Developer : Dipankar ||*/
  ...
  SELECT GINVIEW.FNC_UK ()                   UK,
    ...
    FROM PURORDMAIN M
         ...
         LEFT JOIN INVGRTDET GT
            ON GD.CODE = GT.INVGRCDET_CODE AND GD.GRCCODE = GT.GRCCODE
         LEFT JOIN INVGRTMAIN GTM ON GT.GRTCODE = GTM.GRTCODE
