/* Formatted on 2025-02-04 17:34:14 (QP5 v5.294) */
/*><><>< || Custom Development || Object : CQ_SO_SI_CUS || Ticket Id : 391752 || Developer : Dipankar || ><><><*/
  SELECT GINVIEW.FNC_UK () UK,
         ...
         LGT.DOCUMENT_DATE::date LR_DOC_DATE,
   ...
   WHERE m.saletype = 'O'
   and SIM.INVDT::date BETWEEN TO_DATE ('@DTFR@', 'YYYY-MM-DD')
